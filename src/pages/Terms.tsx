...
// Didn't want to do this but my parents said if the site was earing revenue I kinda had to (All T&C's are generated by AI)
...
/**
 * Terms of Service page component with animated sections and contact info
 */
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        {/* Main terms sections with staggered animations */}
        <motion.div
        ...
        {/* Contact information section for legal inquiries */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
