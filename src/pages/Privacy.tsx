// Privacy policy page
// Apparently this is an important page to have (Privacy policy is generated by AI)
...
/**
 * Interface for privacy policy section structure
 */
interface Section {
  title: string;
  icon: LucideIcon;
...
/**
 * Privacy policy content organized by sections with icons and colors
 */
...
/**
 * Animation variants for individual section items
 */
const itemVariants = {
...
/**
 * Privacy Policy page component with detailed sections and contact information
 */
export default function Privacy() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      {/* Hero section with privacy shield icon and page description */}
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        {/* Main privacy policy sections with icons and staggered animations */}
        <motion.div
        ...
        {/* Contact section for privacy-related inquiries */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        {/* Cookie usage notice and consent information */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
