...
import { X, Sparkles, ChevronRight, Check, Zap, Brain, Clock, Star, Lock, Award } from 'lucide-react';
...
export default function LimitReachedDialog({ isOpen, onClose }: LimitReachedDialogProps) {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Process longer documents faster"
    },
    {
    ...
    },
    {
      ...
      description: "Advanced document protection"
    },
    {
              ...
              <div className="p-6 md:p-8">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Upgrade to unlock unlimited access and premium features</p>
                  </div>
                </div>
